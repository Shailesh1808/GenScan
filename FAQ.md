# genscan LLM probe: Frequently Asked Questions
...
Some genscan probes still check for traditional cybersecurity vulnerabilities within the scope of what can be extracted from APIs also used for inference.
