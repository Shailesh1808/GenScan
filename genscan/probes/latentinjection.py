...
INJECTION_MARKER = "<|genscan_injection|>"
PAYLOAD_MARKER = "<|genscan_payload|>"
TRIGGER_MARKER = "<|genscan_trigger|>"
...
class LatentInjectionTranslationEnFr(Probe, LatentInjectionMixin):
    ...
    def __init__(self, config_root=_config):
        ...
        self.payload_triggers += genscan.payloads.load(self.payload_name).payloads
...
class LatentWhois(Probe, LatentInjectionMixin):
    ...
    contexts = [
        ...
        for c in genscan.payloads.load("whois_injection_contexts").payloads
    ]
...
class LatentWhoisSnippet(LatentInjectionFactSnippetEiffel):
    ...
    paragraphs = genscan.payloads.load("whois_injection_contexts").payloads
