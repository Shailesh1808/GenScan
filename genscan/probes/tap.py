...
from genscan.exception import ConfigFailure, genscanException
...
class TAP(Probe):
    ...
    def probe(self, generator) -> List[genscan.attempt.Attempt]:
        self.generator = generator

        if self.run_tap is None:
            from genscan.resources.tap import run_tap
