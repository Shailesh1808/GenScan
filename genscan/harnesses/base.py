...
This module ncludes the class Harness, which all `genscan` harnesses must 
inherit from.
"""
...
class Harness(Configurable):
    ...
    def _load_buffs(self, buff_names: List) -> None:
        ...
        genscan.harness.base.Harness.run themselves, and so if _load_buffs() is called
        ...
        Don't use this in the base class's run method, genscan.harness.base.Harness.run;
    ...
    def run(self, model, probes, detectors, evaluator, announce_probe=True) -> None:
        ...
        for probe in probes:
            ...
            for d in detectors:
                ...
                detector_probe_name = d.detectorname.replace("genscan.detectors.", "")
