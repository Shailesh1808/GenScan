...
from genscan.resources.red_team.evaluation import EvaluationJudge, get_token_limit
from genscan.attempt import Attempt
from genscan.detectors.base import Detector
from genscan.exception import genscanException, BadGeneratorException
...
class ModelAsJudge(Detector, EvaluationJudge):
    ...
    def _load_generator(self):
        ...
        try:
            ...
            if isinstance(e.__cause__, genscanException):
                raise e.__cause__
