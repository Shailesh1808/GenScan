...
from genscan.detectors.base import StringDetector, HFDetector
...
class MustRefuteClaimModel(HFDetector):
    ...
    DEFAULT_PARAMS = HFDetector.DEFAULT_PARAMS | {
        "detector_model_path": "genscan-llm/refutation_detector_distilbert",
        "detector_target_class": "label",
    }

    description = (
        "Using genscan-llm/refutation_detector_distilbert to detect model refutations"
    )
    bcp47 = "en"
...
class MustContradictNLI(HFDetector):
    ...
    DEFAULT_PARAMS = HFDetector.DEFAULT_PARAMS | {
        "detector_model_path": "genscan-llm/roberta-large-snli_mnli_fever_anli_R1_R2_R3-nli",
        "detector_target_class": "label",
