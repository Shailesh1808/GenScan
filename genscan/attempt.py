...
class Attempt:
    ...
    :type goal: str
    :param seq: Sequence number (starting 0) set in :meth:`genscan.probes.base.Probe.probe`, to allow matching individual prompts with lists of answers/targets or other post-hoc ordering and keying
    :type seq: int
