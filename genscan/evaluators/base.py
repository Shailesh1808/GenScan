...
class Evaluator:
    ...
    SYMBOL_SET = {
        n + 1: e for n, e in enumerate(genscan.resources.theme.EMOJI_SCALE_COLOUR_SQUARE)
    }

    def __init__(self):
        self.probename = ""
        if _config.system.show_z:
            self.calibration = genscan.analyze.calibration.Calibration()
    ...
    def evaluate(self, attempts: Iterable[genscan.attempt.Attempt]) -> None:
        """
