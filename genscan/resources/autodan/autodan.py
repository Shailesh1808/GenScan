...
from genscan._plugins import load_plugin
from genscan.generators import Generator
from genscan.generators.huggingface import Model
import genscan._config
from genscan.data import path as data_path
from genscan.resources.autodan.genetic import (
    get_score_autodan,
    autodan_ga,
    autodan_hga,
    apply_gpt_mutation,
)
from genscan.resources.autodan.model_utils import (
    load_conversation_template,
    check_for_attack_success,
)
from genscan.resources.common import REJECTION_STRINGS


logger = getLogger(__name__)

autodan_resource_data = data_path / "autodan"
cached_autodan_resource_data = genscan._config.transient.cache_dir / "data" / "autodan"
...
def autodan_generate(
    ...
    Args:
        generator (genscan.generators.Generator): Loaded genscan generator
