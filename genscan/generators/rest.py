...
from genscan.exception import APIKeyMissingError, BadGeneratorException, RateLimitHit
...
class RestGenerator(Generator):
    ...
    See reference docs for details (https://reference.genscan.ai/en/latest/genscan.generators.rest.html)
    """
