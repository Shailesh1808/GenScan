...
Then, when invoking genscan, we pass it the path to the generator option file.

```
python -m genscan --model_type litellm --model_name "phi" --generator_option_file ollama_base.json -p dan
```
"""
